...
- A small number of individual data points in the source LAUS data are
  suppressed by BLS (marked `-`) and converted to NULL in staging. This
  can surface as NaN in derived columns like month-over-month change.
